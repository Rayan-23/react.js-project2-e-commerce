  ...
  return (
    <Listbox value={selected} onChange={setSelected}>
      ...
      <div className="relative mt-2">
        <ListboxButton
          className="grid w-full cursor-default grid-cols-1  pr-2 pl-3 text-left text-black outline-1 -outline-offset-1 outline-white/10 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-500 sm:text-sm/6   focus:border-indigo-500 
      focus:outline-none focus:ring-1 focus:ring-indigo-500
       rounded-md px-2 py-2 text-md"
        >
          <span
            className="border-gray-300 shadow-md col-start-1 row-start-1 flex items-center gap-3 
           p-3   "
          >
            <img
              alt=""
